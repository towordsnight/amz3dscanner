...
if __name__ == "__main__":
    ...
    # print("FPS: ", fps)
    try:
        # config_path = "/home/amazonrob/amz3dscan/capture/MediumDensityPreset-custom.json"
        ...
        #     os.unlink(config_path)  # Remove empty file
        config_path = "PresetCustom.json"
        with open(config_path, 'r') as f:
        # with open("/home/amazonrob/amz3dscan/capture/MediumDensityPreset-custom.json") as f:
            jsonObj = json.load(f)
            json_string= str(jsonObj).replace("'", '\"')
